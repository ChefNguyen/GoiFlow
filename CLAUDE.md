...
This project is indexed by GitNexus as **GoiFlow** (950 symbols, 1524 relationships, 40 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
