...
This project is indexed by GitNexus as **GoiFlow** (757 symbols, 1237 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
