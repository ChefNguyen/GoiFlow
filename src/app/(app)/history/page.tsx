...
export default function HistoryPage() {
  return (
    <div className="relative flex min-h-[calc(100vh-65px)] w-full bg-[var(--color-surface)]">
      <main className="flex-1 px-6 py-10 lg:pr-[404px] lg:pl-12">
      ...
      <aside className="hidden w-[380px] shrink-0 border-l border-[var(--color-primary)] bg-[var(--color-surface-container-low)] p-8 lg:flex lg:flex-col lg:overflow-y-auto">
        <header className="mb-12">
        ...
        <div className="mb-16 flex flex-col items-center border-b border-[var(--color-outline-variant)] pb-12">
        ...
        <div className="mt-4 border-t-2 border-[var(--color-primary)] pt-6">
